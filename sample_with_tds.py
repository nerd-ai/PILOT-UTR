...
def main():
    parser = argparse.ArgumentParser("Generate sequences with TDS guidance over a pretrained diffusion model.")
    ...
    parser.add_argument("--alpha", type=float, default=1.0, help="TDS resampling temperature.")
